<div class="">
            ...
            <div class="col-md-2">
            <button onclick="location.href='<?php echo base_url();?>LaporanPdf/LaporanPemakai'">Laporan PDF</button>
            </div>
            <div class="clearfix" style="padding-bottom: 20px"></div>
            <table id="datatable" class="table table-bordered-bottom" style="color: #3B3C3C;">
                      ...
                      <tbody>
                        <?php $no=1; foreach($laporanpemakai as $l) { ?>
                        <tr>
                          <td><?php echo $no ?></td>
                          <td><?php echo $l->Nama_Propinsi ?></td>
                          <td><?php echo $l->Id_Propinsi ?></td>
                          <td><?php echo $l->Id_Kontrasepsi ?></td>
                          <td><?php echo $l->Jumlah_Pemakai ?></td>                         
                        </tr>
                        <?php $no++; } ?>
                      </tbody>
                    </table>
...
<div class="modal fade bs-example-modal-lg add" tabindex="-1" role="dialog" aria-hidden="true">
                          <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" action="<?php echo base_url() ?>Dashboard/tambahPropinsi" method="POST" enctype="multipart/form-data">
                          <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                ...
                                <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Nama_Propinsi">Kontrasepsi
                                  </label>
                                   <div class="col-md-6 col-sm-6 col-xs-12">
                                  <select name="nama_pelanggan" id="pelanggan">
                                ...
                                <div class="form-group">
                                  <label class="control-label col-md-3 col-sm-3 col-xs-12" for="Nama_Propinsi">Jumalah Pemakai
                                  </label>
                                  <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="Nama_Propinsi" name="Nama_Propinsi" required="required" class="form-control col-md-7 col-xs-12">
                                  </div>
                                </div>
